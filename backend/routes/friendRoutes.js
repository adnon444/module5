...
router.get('/:id', (req, res) => {
    ...
    matchedFriend ? res.status(200).json({result: `Friends #${friendId} found`, data: matchedFriend}) : res.status(404)._construct.json({result: `Friends #${friendId} not found`})
})
...
router.put('/:id', (req, res) => {
    ...
    res.status(404).json({result: 'No firned with ID' + friendId})
